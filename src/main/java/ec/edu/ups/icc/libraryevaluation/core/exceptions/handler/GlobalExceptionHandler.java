package ec.edu.ups.icc.libraryevaluation.core.exceptions.handler;
...
import ec.edu.ups.icc.libraryevaluation.core.dto.ErrorResponseDto;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleValidation(MethodArgumentNotValidException ex,
        ...
        return build(HttpStatus.BAD_REQUEST, "VALIDATION_ERROR", "Invalid request data", request.getRequestURI(),
                details);
    }

package ec.edu.ups.icc.libraryevaluation.users.controllers;
...
import ec.edu.ups.icc.libraryevaluation.users.services.UserService;
...
public class UserController {
    ...
    public List<UserResponseDto> findActiveReaders(
        ...
        return service.findActiveReaders(minAge);
    }
}
